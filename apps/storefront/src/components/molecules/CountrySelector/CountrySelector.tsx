...
const CountrySelect = ({ regions }: CountrySelectProps) => {
  ...
  const countryCode = Array.isArray(locale) ? locale[0] : locale
  ...
  if (!mounted) {
    return (
      <div className="md:flex gap-2 items-center justify-end relative">
        ...
        <div>
          <div className="relative w-16 flex justify-between items-center h-10 bg-component-secondary text-left cursor-default border rounded-lg text-base-regular">
